...
export const metadata: Metadata = {
  ...
  title: {
    default: "Jumaa Almarzouk | Fullstack Web & Mobile Developer",
    template: "%s",
  },
  description:
    "Portfolio von Jumaa Almarzouk — Fullstack Web & Mobile Developer (PHP, Laravel, React, Next.js, Vue.js, React Native). Standort: Haselünne, Raum Meppen / Emsland.",
  keywords: [
